				...
				<div class="w-full relative block testimonial">
					...
					>
						<SwiperSlide
							...
							class="!h-auto bg-white cursor-grab"
						>
							<div class="grid grid-cols-11 gap-x-3 bg-white h-full">
								...
								<div
									class="col-span-full flex flex-col justify-between max-lg:pt-[40px] max-lg:pb-8 max-lg:px-2 max-lg:bg-light-grey max-lg:rounded-md lg:col-start-4 lg:col-span-7 lg:row-start-2"
								>
