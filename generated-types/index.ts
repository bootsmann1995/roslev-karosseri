...
export type LandingPageModelBlokListeField =
	| FiftyBlockRecord
	| GalleryBlockRecord
	| ImageBlockRecord
	| LinkBlockRecord
...
export type FiftyBlockModelLinkField =
	| ContactPageRecord
	| ForsideRecord
	| LandingPageRecord
	| NewsPageRecord
...
export type ProductItemModelTextLinksField =
	| ContactPageRecord
	| ForsideRecord
	| LandingPageRecord
	| NewsPageRecord
...
export type NewsPageModelBlokListeField =
	| FiftyBlockRecord
	| GalleryBlockRecord
	| ImageBlockRecord
	| LinkBlockRecord
...
export type LinkBlockModelLinkField =
	| ContactPageRecord
	| ForsideRecord
	| LandingPageRecord
	| NewsPageRecord
...
export type MenuItemModelMenuLinkField =
	| ContactPageRecord
	| ForsideRecord
	| LandingPageRecord
	| NewsPageRecord
...
export type ProductPageModelBlokListeField =
	| FiftyBlockRecord
	| GalleryBlockRecord
	| ImageBlockRecord
	| LinkBlockRecord
...
export type TextBlockModelTextLinksField =
	| ContactPageRecord
	| ForsideRecord
	| LandingPageRecord
	| NewsPageRecord
...
export type FiftyBlockModelTextLinksField =
	| ContactPageRecord
	| ForsideRecord
	| LandingPageRecord
	| NewsPageRecord
...
type BlockListFrament_FiftyBlockRecord_Fragment = {
	__typename?: "FiftyBlockRecord";
	id: any;
	headline?: string | null;
	_modelApiKey: string;
	link?:
		| { __typename?: "ContactPageRecord"; id: any; slug?: string | null; headline?: string | null }
		| { __typename?: "ForsideRecord"; id: any; slug?: string | null; overskrift?: string | null }
		| { __typename?: "LandingPageRecord"; id: any; slug?: string | null; overskrift?: string | null }
		| {
				__typename?: "NewsPageRecord";
				id: any;
				...
				parent?: {
					__typename?: "NewsPageRecord";
					slug?: string | null;
					parent?: { __typename?: "NewsPageRecord"; slug?: string | null } | null;
				} | null;
		  }
		| {
				__typename?: "ProductPageRecord";
				...
				parent?: {
					__typename?: "ProductPageRecord";
					slug?: string | null;
					parent?: { __typename?: "ProductPageRecord"; slug?: string | null } | null;
				} | null;
		  }
		| null;
	text?: {
...
type BlockListFrament_GalleryBlockRecord_Fragment = {
	__typename?: "GalleryBlockRecord";
	id: any;
	_modelApiKey: string;
	images: Array<{
...
type BlockListFrament_ImageBlockRecord_Fragment = {
	__typename?: "ImageBlockRecord";
	id: any;
	_modelApiKey: string;
	image?: {
...
type BlockListFrament_LinkBlockRecord_Fragment = {
	__typename?: "LinkBlockRecord";
	_modelApiKey: string;
	id: any;
	link?:
...
type BlockListFrament_TextBlockRecord_Fragment = {
	__typename?: "TextBlockRecord";
	id: any;
	_modelApiKey: string;
	text?: {
...
export type BlockListFramentFragment =
	| BlockListFrament_FiftyBlockRecord_Fragment
	| BlockListFrament_GalleryBlockRecord_Fragment
	| BlockListFrament_ImageBlockRecord_Fragment
	| BlockListFrament_LinkBlockRecord_Fragment
	| BlockListFrament_TextBlockRecord_Fragment;

export type FiftyFiftyFragmentFragment = {
	__typename?: "FiftyBlockRecord";
	id: any;
	headline?: string | null;
	_modelApiKey: string;
...
export type GalleryBlockFragmentFragment = {
	__typename?: "GalleryBlockRecord";
	id: any;
	_modelApiKey: string;
	images: Array<{
...
export type ImageBlockFragmentFragment = {
	__typename?: "ImageBlockRecord";
	id: any;
	_modelApiKey: string;
	image?: {
...
type LinkFragment_ContactPageRecord_Fragment = {
	__typename?: "ContactPageRecord";
	id: any;
	slug?: string | null;
	headline?: string | null;
...
type LinkFragment_ForsideRecord_Fragment = {
	__typename?: "ForsideRecord";
	id: any;
	slug?: string | null;
	overskrift?: string | null;
...
type LinkFragment_LandingPageRecord_Fragment = {
	__typename?: "LandingPageRecord";
	id: any;
	slug?: string | null;
	overskrift?: string | null;
...
type LinkFragment_NewsPageRecord_Fragment = {
	__typename?: "NewsPageRecord";
	id: any;
	overskrift?: string | null;
	slug?: string | null;
...
type LinkFragment_ProductPageRecord_Fragment = {
	__typename?: "ProductPageRecord";
	id: any;
	overskrift?: string | null;
	slug?: string | null;
...
export type LinkFragmentFragment =
	| LinkFragment_ContactPageRecord_Fragment
	| LinkFragment_ForsideRecord_Fragment
	| LinkFragment_LandingPageRecord_Fragment
	| LinkFragment_NewsPageRecord_Fragment
	| LinkFragment_ProductPageRecord_Fragment;

export type LinkBlockFragmentFragment = {
	__typename?: "LinkBlockRecord";
	_modelApiKey: string;
	id: any;
	link?:
...
export type TextBlockFragmentFragment = {
	__typename?: "TextBlockRecord";
	id: any;
	_modelApiKey: string;
	text?: {
...
export type FrontpageQuery = {
	__typename?: "Query";
	forside?: { __typename?: "ForsideRecord"; overskrift?: string | null } | null;
};
	...
	definitions: [
		{
			...
			typeCondition: { kind: "NamedType", name: { kind: "Name", value: "LinkBlockModelLinkField" } },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
						kind: "InlineFragment",
						typeCondition: { kind: "NamedType", name: { kind: "Name", value: "ContactPageRecord" } },
						selectionSet: {
							kind: "SelectionSet",
							selections: [
					...
					{
						kind: "InlineFragment",
						typeCondition: { kind: "NamedType", name: { kind: "Name", value: "ForsideRecord" } },
						selectionSet: {
							kind: "SelectionSet",
							selections: [
								{ kind: "Field", name: { kind: "Name", value: "id" } },
								{ kind: "Field", name: { kind: "Name", value: "slug" } },
								{ kind: "Field", name: { kind: "Name", value: "overskrift" } },
							],
						},
					},
					{
						kind: "InlineFragment",
						typeCondition: { kind: "NamedType", name: { kind: "Name", value: "LandingPageRecord" } },
						selectionSet: {
							kind: "SelectionSet",
							selections: [
								{ kind: "Field", name: { kind: "Name", value: "id" } },
					...
					{
						kind: "InlineFragment",
						typeCondition: { kind: "NamedType", name: { kind: "Name", value: "NewsPageRecord" } },
						selectionSet: {
							kind: "SelectionSet",
							selections: [
								{ kind: "Field", name: { kind: "Name", value: "id" } },
					...
					{
						kind: "InlineFragment",
						typeCondition: { kind: "NamedType", name: { kind: "Name", value: "ProductPageRecord" } },
						selectionSet: {
							kind: "SelectionSet",
							selections: [
								{ kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<LinkFragmentFragment, unknown>;
								...
								value: {
									...
									fields: [
										...
										},
										{
											...
											value: { kind: "StringValue", value: "85", block: false },
										},
										{
											kind: "ObjectField",
...
export const FiftyFiftyFragmentFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			...
			selectionSet: {
				...
				selections: [
					...
					{ kind: "Field", name: { kind: "Name", value: "_modelApiKey" } },
					{
						...
						selectionSet: {
							kind: "SelectionSet",
							selections: [{ kind: "FragmentSpread", name: { kind: "Name", value: "LinkFragment" } }],
						},
					},
					{
						kind: "Field",
							...
							selections: [
								{
									...
									selectionSet: {
										kind: "SelectionSet",
										selections: [
											{ kind: "FragmentSpread", name: { kind: "Name", value: "LinkFragment" } },
										],
									},
								},
...
} as unknown as DocumentNode<FiftyFiftyFragmentFragment, unknown>;
export const ImageBlockFragmentFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "ImageBlockFragment" },
			typeCondition: { kind: "NamedType", name: { kind: "Name", value: "ImageBlockRecord" } },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{ kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<ImageBlockFragmentFragment, unknown>;
export const GalleryBlockFragmentFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "GalleryBlockFragment" },
			typeCondition: { kind: "NamedType", name: { kind: "Name", value: "GalleryBlockRecord" } },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{ kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<GalleryBlockFragmentFragment, unknown>;
export const TextBlockFragmentFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "TextBlockFragment" },
			typeCondition: { kind: "NamedType", name: { kind: "Name", value: "TextBlockRecord" } },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{ kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<TextBlockFragmentFragment, unknown>;
export const LinkBlockFragmentFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "LinkBlockFragment" },
			typeCondition: { kind: "NamedType", name: { kind: "Name", value: "LinkBlockRecord" } },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{ kind: "Field", name: { kind: "Name", value: "_modelApiKey" } },
...
} as unknown as DocumentNode<LinkBlockFragmentFragment, unknown>;
export const BlockListFramentFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "BlockListFrament" },
			typeCondition: { kind: "NamedType", name: { kind: "Name", value: "LandingPageModelBlokListeField" } },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{ kind: "FragmentSpread", name: { kind: "Name", value: "FiftyFiftyFragment" } },
					{ kind: "FragmentSpread", name: { kind: "Name", value: "ImageBlockFragment" } },
					{ kind: "FragmentSpread", name: { kind: "Name", value: "GalleryBlockFragment" } },
					{ kind: "FragmentSpread", name: { kind: "Name", value: "TextBlockFragment" } },
					{ kind: "FragmentSpread", name: { kind: "Name", value: "LinkBlockFragment" } },
				],
			},
		},
		{
...
} as unknown as DocumentNode<BlockListFramentFragment, unknown>;
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "forside" },
						selectionSet: {
							kind: "SelectionSet",
							selections: [{ kind: "Field", name: { kind: "Name", value: "overskrift" } }],
						},
					},
				],
			},
				...
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								{
									kind: "Field",
									name: { kind: "Name", value: "introImage" },
									selectionSet: {
										kind: "SelectionSet",
										selections: [
											{ kind: "FragmentSpread", name: { kind: "Name", value: "ImageFragment" } },
										],
									},
								},
								{ kind: "Field", name: { kind: "Name", value: "overskrift" } },
								...
								{
									kind: "Field",
									name: { kind: "Name", value: "blokListe" },
									selectionSet: {
										kind: "SelectionSet",
										selections: [
											{
...
} as unknown as DocumentNode<LandingPageQuery, LandingPageQueryVariables>;
				...
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{
									kind: "Field",
									name: { kind: "Name", value: "productMenu" },
									selectionSet: {
										kind: "SelectionSet",
										selections: [
											{
												kind: "Field",
												name: { kind: "Name", value: "menuLink" },
												selectionSet: {
													kind: "SelectionSet",
													selections: [
														{
											...
											{
												kind: "Field",
												name: { kind: "Name", value: "childMenuLinks" },
												selectionSet: {
													kind: "SelectionSet",
													selections: [
														{
